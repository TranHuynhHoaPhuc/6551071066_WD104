...
// ====== Câu 3: Ẩn / Hiện danh sách sản phẩm (fadeToggle) ======
$(document).ready(function () {
  $("#toggle-btn").click(function () {
    $(".best_product_slider").fadeToggle(600);
  });
});
// ====== CÂU 4: VALIDATE FORM LIÊN HỆ ======
$(document).ready(function () {
  $("#contactForm").submit(function (e) {
    ...
    if (!emailPattern.test(email)) {
      alert(" Email không hợp lệ! (phải có ký tự @ và dấu chấm .)");
      return;
    }

 
    alert(" Gửi liên hệ thành công! Cảm ơn bạn đã gửi thông tin.");
    $("#contactForm")[0].reset();
  });
});
